...
- **Prerequisites**: We assume you've completed [Hello GitHub Actions](https://github.com/Lepont-DataEng/01-hello-github-actions) first.
...
'https://github.com/new?' + new URLSearchParams({
  ...
  owner: '@me',
  name: 'Lepont-DataEng-02-test-with-actions',
  description: 'My clone repository',
  visibility: 'public',
}).toString()
-->

[![start-course](https://user-images.githubusercontent.com/1221423/235727646-4a590299-ffe5-480d-8cd5-8194ea184546.svg)](https://github.com/new?template_owner=Lepont-DataEng&template_name=02-test-with-actions&owner=%40me&name=Lepont-DataEng-02-test-with-actions&description=My+clone+repository&visibility=public)
